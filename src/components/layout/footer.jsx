...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col border-t-2 border-b-2 dark:border-gray-700 py-2 mt-10 mb-16 md:mb-0">
      <div className="text-xs text-center font-light px-2 flex justify-center gap-1">barış sönmez (c) {year}. made with <span className="text-green-800 dark:text-gray-200 flex gap-1 items-center"><FontAwesomeIcon icon={faReact} className="w-4" /> <span>Next.js 14</span></span>.</div>
