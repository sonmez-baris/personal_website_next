...
const Sidebar = () => {
  ...
  return(
    <>
      <div className="overflow-y-auto fixed gap-y-4 mt-10 hidden md:flex flex-col flex-shrink-0">

        <Link href="/">
        <div className="w-8 h-8 inline-flex items-center justify-center text-center text-xl" data-tooltip-target="tooltip-right" data-tooltip-placement="right">
        ...
        <Link href="/profile">
        <div className="w-8 h-8 inline-flex items-center justify-center text-center text-xl">
          <svg id="icon" xmlns="http://www.w3.org/2000/svg" className="fill-current text-bsonmezprimary dark:text-gray-300" width="32" height="32" viewBox="0 0 32 32">
        ...
        <div className="w-8 h-8 hidden dark:inline-flex items-center justify-center text-center text-xl">
          <svg id="icon" xmlns="http://www.w3.org/2000/svg" className="fill-current text-bsonmezprimary dark:text-gray-300" width="32" height="32" viewBox="0 0 32 32">
      ...
      <div className="bottom-0 w-full min-h-12 py-3 bg-white fixed md:hidden flex flex-row flex-wrap justify-evenly items-center gap-x-4 dark:bg-gray-800 border-t-2 dark:border-gray-600">
