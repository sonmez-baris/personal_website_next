...
const Post = () => {
  ...
  return (
    <div className="flex flex-col px-2 mt-4 overflow-hidden">
      <div className="w-full h-92">
        { data.data.cover && <Image src={`${config.API_URL}/../../${data.data.cover}`} alt="Barış" width={600} height={400} objectFit="cover" /> }
      </div>
